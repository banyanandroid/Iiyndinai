...
public class Activity_Cart extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener{
...
*/
            ...
            public void onClick(View v) {
                ...
                if (str_status.equals("true")) {
                    ...
                    SharedPreferences sharedPreferences = PreferenceManager
                            .getDefaultSharedPreferences(Activity_Cart.this);
                    ...
                    new AlertDialog.Builder(Activity_Cart.this)
                            ...
                            .setNegativeButton("Ok", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent i = new Intent(Activity_Cart.this, Activity_Login.class);
                                    startActivity(i);
                                    finish();
            ...
            public void onClick(View view) {
                ...
                if (str_status.equals("true")) {
                    ...
                    if (str_cart_status == 1) {
                        ...
                        Intent intent = new Intent(Activity_Cart.this, WebViewActivity.class);
                    ...
                    .setPositiveButton("Yes",
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog,
                                    ...
                                    // TODO Auto-generated method stub
                                    // finish();
                                    Intent ins = new Intent(Activity_Cart.this, Activity_Cart.class);
                                    startActivity(ins);
                                }
                            }).show();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Crouton.makeText(Activity_Cart.this,
                                "No Products In Cart!",
                                Style.ALERT)
                                .show();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        cartAdapter = new CartAdapter(Activity_Cart.this, prod_list_arr);
                                ...
                                .setPositiveButton("Done",
                                        new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog,
                                                ...
                                                // TODO Auto-generated method stub
                                                // finish();
                                                Intent ins = new Intent(Activity_Cart.this, MainActivity.class);
                                                startActivity(ins);
                                            }
                                        }).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.actionbar_search) {
            ...
            Intent in = new Intent(Activity_Cart.this, Activity_Search.class);
            startActivity(in);
            return true;
        }
        ...
        switch (position) {
            case 0:
                try {
                    ...
                    Intent hotmain = new Intent(Activity_Cart.this, MainActivity.class);
            ...
            case 1:
                ...
                try {
                    ...
                    Intent hot = new Intent(Activity_Cart.this, Activity_HotDeals.class);
                    startActivity(hot);
            ...
            case 2:
                ...
                try {
                    ...
                    Intent inm = new Intent(Activity_Cart.this, Activity_WishList.class);
                    startActivity(inm);
                    overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                    finish();
            ...
            case 3:
                ...
                try {
                    ...
                    Intent ine = new Intent(Activity_Cart.this, Activity_Enquiry.class);
                    startActivity(ine);
                    overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
                    finish();
            ...
            case 4:
                ...
                try {
                    ...
                    Intent notification = new Intent(Activity_Cart.this, Activity_My_Order.class);
            ...
            case 5:
                ...
                try {
                    ...
                    Intent orders = new Intent(Activity_Cart.this, Activity_MyAccount.class);
